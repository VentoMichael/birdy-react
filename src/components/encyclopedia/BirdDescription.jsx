                ...
                <section>
                    ...
                    <div className="container__login">
                        ...
                        <section className="box__container container__house">
                            <h3 aria-level="3">Habitat</h3>
                            <p>
                                {this.state.bird.habitat}
                            </p>
                        </section>
                        <section className="box__container container__map">
                            <h3 aria-level="3">Distribution</h3>
                            <div>{this.state.bird.distribution ?
                                <GMap initialPos={{lat: 50.63093493440036, lng: 5.5671638926487175}}
                                      positions={this.state.bird.distribution} zoom={8}
                                      getCoordinates={true}/> : '/'}</div>
                        </section>
                        <section className="box__container">
                            <h3 aria-level="3">Chant</h3>
                            <div>{this.state.bird.chipping ? <Audio audio={this.state.bird.chipping}/> : '/'}</div>
                        </section>
                    </div>
                </section>
            </React.Fragment>
